...
<head>
  ...
  <style>
    ...
    /* Make search input visually like mock (light bg) */
    .search-input {
      width: 260px;
      max-width: 40vw;
    }
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        ...
        <form class="d-flex me-3" onsubmit="return false;">
          <input class="form-control rounded-pill search-input" style="background-color:rgba(255,255,255,0.8)" type="search" placeholder="Cari proyek..." aria-label="Cari proyek">
        </form>
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end text-center p-3" style="min-width: 220px;">
            ...
            <!-- keep visual the same but make JS handle logout action -->
  ...
  <section class="hero position-relative">
    <div class="container text-center">
      ...
      <!-- Tombol Upload intentionally removed to match visual -->
    </div>
  ...
  <!-- ✅ Script: fungsi login/logout & proteksi (diambil dari versi pertama) -->
  <script>
    // Ambil user dari localStorage (sama seperti versi fungsi asli)
    const currentUser = JSON.parse(localStorage.getItem("currentUser"));

    // Jika belum login => tampilkan SweetAlert dan redirect ke login.html
    // (Proteksi halaman - fungsi dari versi pertama)
    if (!currentUser) {
      Swal.fire({
        icon: "warning",
      ...
      // Jika ada user, tampilkan namanya di dropdown
    ...
    // Logout menggunakan SweetAlert (sama persis seperti versi pertama)
    document.getElementById("logoutBtn").addEventListener("click", (e) => {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // Jika ada flag isDosen simpan juga dihapus atau dibiarkan tergantung aplikasi.
    ...
    // Proteksi klik ke profil & portofolio (sama seperti versi pertama)
    ...
    if (isDosen && portoLink) {
      ...
      // pastikan link ke "hasil.html" (default mahasiswa)
