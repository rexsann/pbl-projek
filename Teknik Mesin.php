...
<body>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav me-3">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item active" href="Teknik Mesin.html">Teknik Mesin</a></li>
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end text-center p-3" style="min-width: 220px;">
            ...
            <li><a class="dropdown-item text-white" href="hasil.html">📁 My Portofolio</a></li>
  ...
  <section class="hero position-relative">
    <div class="container text-center">
      ...
      <a href="upload2.html" class="btn btn-upload mt-3">📤 Upload Portofolio</a>
    </div>
